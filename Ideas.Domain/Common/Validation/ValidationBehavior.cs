...
namespace Ideas.Domain.Common.Validation
{
    ...
    //public class ValidationBehavior<TRequest> : IPipelineBehavior<TRequest, Unit> where TRequest : IRequest
    //{
    //    private readonly IValidator<TRequest> _validator;
    ...
    //    public Task<Unit> Handle(TRequest request, RequestHandlerDelegate<Unit> next)
    //    {
    //        if (_validator == null)
    //            return next();
